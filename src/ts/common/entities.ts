...
const leciPickable = mixPickable(31, 45);
export const leci_1 = collectable(n('leci-1'), sprites.leci_1, 0, leciPickable);
export const leci_2 = collectable(n('leci-2'), sprites.leci_2, 0, leciPickable);
export const leci_3 = collectable(n('leci-3'), sprites.leci_3, 0, leciPickable);
export const leci_4 = collectable(n('leci-4'), sprites.leci_4, 0, leciPickable);
...
// baru
export const mangkokBakso = collectable(n('piring-bakso'), sprites.food_on_plates_mangkok_bakso, 0, mixPickable(31, 50));
export const mangkok = collectable(n('mangkok'), sprites.food_on_plates_mangkok, 0, mixPickable(31, 50));
export const piringSate = collectable(n('piring-sate'), sprites.food_on_plates_piringkecil_sate, 0, mixPickable(31, 51));
export const piring = collectable(n('piring'), sprites.food_on_plates_piringkecil, 0, mixPickable(31, 51));
...
// Koleksi baru
export const gerobakBakso = doodad(n('gerobak_bakso'), sprites.carts_bakso, 41, 64, 0,
	mixFlags(EntityFlags.Interactive),
	base => base.interactRange = 5,
	mixInteractAction(InteractAction.GiveMangkokBakso),
	mixColliderRect(-45, 0, 89, 19));

	export const gerobakSateLit = doodad(n('gerobak_sate_lit'), sprites.carts_sate_lit, 41, 64, 0,
	mixFlags(EntityFlags.Interactive),
	base => base.interactRange = 5,
	mixInteractAction(InteractAction.GivePiringSate),
	mixColliderRect(-45, 0, 89, 20));
...
// bendera
export const indoFlag1 = doodad(n('indo-flag-1'), sprites.indo_flags_1, 8, 54, 0,
mixColliderRect(-8, 0, 20, 19));

export const indoFlag2 = doodad(n('indo-flag-2'), sprites.indo_flags_2, 8, 63, 0,
mixColliderRect(-9, 1, 20, 26)); 

export const gerobakSateUnlit = doodad(n('grobak-sate-unlit'), sprites.carts_sate_unlit, 41, 64, 0,
mixColliderRect(-45, 0, 89, 20));

//export const mangkokBakso = doodad(n('mangkok-bakso'), sprites.food_on_plates_mangkok_bakso, 7, 5, 0);

// raflesia
export const raflesia1 = decal(n('raflesia-1'), sprites.raflesia_arnoldi_1);
export const raflesia2 = decal(n('raflesia-2'), sprites.raflesia_arnoldi_2);
...
export const placeableEntities: { type: number; name: string; }[] = [
	...
	// baru
	{ type: gerobakBakso.type, name: 'Gerobak Bakso' },
	{ type: gerobakSateLit.type, name: 'Gerobak Sate' },
];

export const fruits = [
	apple, apple2, appleGreen, appleGreen2, orange, pear, banana,
	lemon, lime, leci_1, leci_2, leci_3, leci_4, carrotHeld, mango, grapesGreen[0], grapesPurple[0],
];
...
// baru
export const mangkokBaksoTypes = [mangkokBakso, mangkok].map(e => e.type);
export const piringSateTypes = [piringSate, piring].map(e => e.type);
