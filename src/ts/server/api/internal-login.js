...
exports.createInternalLoginApi = exports.createUpdateLiveSettings = exports.createLoginServerStats = exports.createLoginServerState = exports.createLoginServerStatus = void 0;
...
var createLoginServerState = function (settings, live) {
    return function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, createLoginServerStatus(settings, live)];
    }); }); };
};
exports.createLoginServerState = createLoginServerState;
var createLoginServerStats = function (statsTracker) {
    return function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, statsTracker.getStats()];
    }); }); };
};
exports.createLoginServerStats = createLoginServerStats;
var createUpdateLiveSettings = function (liveSettings) {
    return function (update) { return __awaiter(void 0, void 0, void 0, function () {
...
var createInternalLoginApi = function (settings, live, statsTracker, reloadSettings, removedDocument) {
    return ({
        ...
        mergeAccounts: function (id, withId, reason, allowAdmin, creatingDuplicates) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (live.shutdown) {
                        ...
                        return [4 /*yield*/, merge_1.mergeAccounts(id, withId, reason, removedDocument, allowAdmin, creatingDuplicates)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
