...
function addSeasonalObjects(world: World, map: ServerMap, season: Season, holiday: Holiday) {
	...
	if (isSpring || isSummer) {
		//Gerobak
		add(entities.gerobakSateLit(70.5, 63.8));
		add(entities.gerobakSateUnlit(70.5, 63.8));
		add(entities.gerobakBakso(67, 45));

		//Bendera
		add(entities.indoFlag2(61, 93));

		//Raflesia
		add(entities.raflesia1(51.75, 136));
		add(entities.raflesia1(54, 137));
		add(entities.raflesia1(50.5, 138));
		add(entities.raflesia2(52, 138));
		add(entities.raflesia2(54, 139));
		add(entities.raflesia2(52, 140));
...
export function createMainMap(world: World): ServerMap {
	...
	add(createSignWithText(70.5, 70.5, 'Nusa Town', '      Nusa Town\n[under construction]', entities.sign));
	...
	add(createSign(77.06, 60.16, 'Tanda Mawar', give(entities.rose.type, `Ini mawarmu!`), entities.sign));

	if (world.featureFlags.test) {
		add(createSign(14.5, 70, 'Pulau Publik', (_, client) => goToMap(world, client, 'public-island'), entities.signDebug));
	...
	// sumur
	add(entities.well(63, 63));

	// pohon
	addTree(70, 62.5, 0);

	// tanda
	add(createSign(65, 63, 'Tanda Surat', give(entities.letter.type, `Ini suratmu!`), entities.sign));
