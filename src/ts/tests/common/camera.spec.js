...
describe('Camera', function () {
    describe('updateCamera()', function () {
        it('should not move camera if already in view', function () {
            var camera = camera_1.createCamera();
            camera.w = 512;
            camera.h = 480;
            camera.x = 1344;
        ...
        it('should move camera if player is not in view', function () {
            var camera = camera_1.createCamera();
            camera.w = 512;
            camera.h = 480;
            camera.x = 1344;
        ...
        it('does not restrict camera position if camera is not near the edge of map', function () {
            var camera = camera_1.createCamera();
        ...
        it('restricts camera position to top left edge of map', function () {
            var camera = camera_1.createCamera();
            camera.w = positionUtils_1.toScreenX(50);
            camera.h = positionUtils_1.toScreenY(50);
        ...
        it('restricts camera position to bottom right edge of map', function () {
            var camera = camera_1.createCamera();
            camera.w = positionUtils_1.toScreenX(50);
            camera.h = positionUtils_1.toScreenY(50);
        ...
        it('centers map in view if map is smaller than camera view', function () {
            var camera = camera_1.createCamera();
    ...
    describe('centerCameraOn()', function () {
        it('centers camera on point', function () {
            var camera = camera_1.createCamera();
    ...
    describe('isWorldPointVisible()', function () {
        it('returns true if entity position is in view of camera', function () {
            chai_1.expect(camera_1.isWorldPointVisible(camera_1.createCamera(), mocks_1.entity(0, 1, 1))).true;
        });
        it('returns false if entity position is out of view of camera', function () {
            chai_1.expect(camera_1.isWorldPointVisible(camera_1.createCamera(), mocks_1.entity(0, 10, 10))).false;
        });
    });
    describe('isEntityVisible()', function () {
        it('returns true if entity bounds are in view of camera', function () {
            chai_1.expect(camera_1.isEntityVisible(camera_1.createCamera(), mocks_1.entity(0, 1, 1, 1, { bounds: rect_1.rect(0, 0, 0.1, 0.1) }))).true;
        });
        it('returns false if entity bounds are out of view of camera', function () {
    ...
    describe('screenToWorld()', function () {
        it('maps position from screen to world coordinates', function () {
            var camera = camera_1.createCamera();
            camera.x = 32;
    ...
    describe('worldToScreen()', function () {
        it('maps position from world to screen coordinates', function () {
            var camera = camera_1.createCamera();
            camera.x = 32;
            camera.actualY = camera.y = 24;
